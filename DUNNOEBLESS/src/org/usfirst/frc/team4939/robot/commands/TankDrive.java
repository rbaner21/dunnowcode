...
public class TankDrive extends Command {
	...
	private static final double DELTA_LIMIT = 0.80;
	
	/** The Constant RAMP_UP_CONSTANT. */
	private static final double RAMP_UP_CONSTANT = 0.08;
	
	/** The Constant RAMP_DOWN_CONSTANT. */
	private static final double RAMP_DOWN_CONSTANT = 0.08;
